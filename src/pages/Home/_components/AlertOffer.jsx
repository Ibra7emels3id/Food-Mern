        ...
        return (
            <div className={`flex ${showAlert} fixed items-center justify-center z-[10000] left-0 top-0 w-full h-screen bg-[#000000c2]`}>
                <div className="z-[10000]">
                    <div className="flex flex-col relative bg-slate-200 h-[550px] w-[450px] rounded-3xl">
                        <div
                            onClick={handleClose}
                        ...
                        <div className="flex flex-col mt-20 gap-6">
                            ...
                            <h2 className='text-center mt-5 font-bold text-yellow text-4xl'>Discounts up to 30%</h2>
                            <div className="flex flex-col items-center gap-20 mt-10">
                                {offers.slice(0, 2).map((offer, index) => (
                                    <p key={index} className='flex gap-3'>
                                        <span className='text-3xl font-bold'>{offer.code}</span>
