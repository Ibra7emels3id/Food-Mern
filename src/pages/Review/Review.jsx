                                        ...
                                        <div className="flex flex-col">
                                            <div className="flex items-center gap-0.5 text-green-500">
                                                <div className="image mr-4">
                                                    {it?.image ? <img  loading='lazy' className="object-cover w-20 h-20 rounded-full" src={it.image} alt="Image 1" /> : <img  loading='lazy' className="object-cover w-20 h-20 rounded-full" src={'https://img.freepik.com/free-photo/handsome-confident-smiling-man-with-hands-crossed-chest_176420-18743.jpg'} alt="Image 1" />}
                                                </div>
                                                <div className="title">
