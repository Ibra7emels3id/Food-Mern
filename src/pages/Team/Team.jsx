    ...
    return (
        <>
                ...
                <div className="container flex justify-center mx-auto pt-16">
                    <div>
                        <p className="text-gray-800  text-lg text-center font-normal pb-3">
                            BUILDING TEAM
                        </p>
                ...
                <div className="w-full bg-gray-100 px-10 pt-10">
                    <div className="container mx-auto">
                        <div
                            ...
                            className="w-full md:w-[90%] m-auto lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around"
                        >
                            <div
                                role="listitem"
                            ...
                            >
                                <div className="rounded overflow-hidden shadow-md bg-white">
                                    ...
                                    <div className="px-6 mt-16">
                                        <h1 className="font-bold dark:text-yellow text-3xl text-center mb-1">
                                            Andres Berlin
                                        </h1>
                                        <p className="text-gray-800 text-sm text-center">
                                            Chief Executive Officer
                                        </p>
                                        <p className="text-center text-gray-400  text-base pt-3 font-normal">
                            ...
                            <div
                                role="listitem"
                                className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 bg-white sm:mb-24 xl:max-w-sm lg:w-2/5"
                            >
                                <div className="rounded overflow-hidden shadow-md bg-whit">
                                    <div className="absolute -mt-20 w-full flex justify-center">
                                        <div className="h-32 w-32">
                                            <img
