                ...
                <div className="overflow-auto py-6 h-full mt-4">
                    <ul className="space-y-1">
                        ...
                        <li>
                            <Link 
                                to="/admin/products"
                                className="text-black hover:text-yellow text-[15px] flex items-center hover:bg-white rounded px-3 py-3 transition-all"
                            >
                            <ShoppingBagIcon />
                                <span className=' hidden md:flex px-3'>Products</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                <CategoryIcon />
                                <span className=' hidden md:flex px-3'>Category</span>
                            </Link>
                        </li>
                        <li>
                            <Link 
