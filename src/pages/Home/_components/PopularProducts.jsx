        ...
        <>
            <div className=" p-5">
                <div className="title flex items-center justify-between w-full">
                    <h2 className='text-sm md:text-3xl font-bold uppercase'>Fruit products</h2>
                    <Link to={'/category/fruits'} className='md:text-lg hover:text-black font-bold text-light'>View All Categories <ArrowForwardIcon /></Link>
                </div>
                <Swiper
                            ...
                            <SwiperSlide key={it._id} className='m-auto  flex items-center justify-center w-full'>
                                <div className="product pt-5 px-5 pb-3 bg-white rounded-lg hover:shadow-xl">
                                    <div className="flex bg-[#f9f9f9]  rounded-lg">
                                        <img  loading='lazy' className='w-full h-56 ' src={it.image} alt="" />
                                    </div>
                                    <h4 className="mt-2 text-2xl font-medium my-2 h-16 flex items-center uppercase font-semibold">{it.title}</h4>
