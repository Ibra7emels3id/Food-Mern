        ...
        <>
            <div className=" p-5">
                <div className="title flex items-center justify-between w-full">
                    <h2 className='text-sm md:text-3xl font-bold uppercase'>Meat products</h2>
                    <Link to={'/category/Meat'} className=' md:text-lg hover:text-black font-bold text-light '>Meat products<ArrowForwardIcon /></Link>
                </div>
                <Swiper
                    slidesPerView={5}
                    spaceBetween={20}
                        ...
                        return (
                            <SwiperSlide key={it._id} className='m-auto  flex items-center justify-center w-full'>
                                <div className="product pt-5 px-5 pb-3 bg-white rounded-lg hover:shadow-xl">
                                    ...
                                    <h4 className="mt-2 text-2xl my-2 h-16 flex items-center uppercase font-semibold">{it.title}</h4>
