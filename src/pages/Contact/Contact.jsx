...
const Contact = () => {
    return (
        <>
            <Header />
            <div className="grid md:grid-cols-2 mx-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-7xl md:mx-auto bg-white mt-16 mb-16 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-yellow before:h-full max-md:before:hidden">
                <div>
