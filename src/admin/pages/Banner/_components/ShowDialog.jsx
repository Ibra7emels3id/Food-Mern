...
import { DeleteOffer, fetchOffers } from '../../../../features/BannersSlice';



const ShowDialog = ({ open, handleClose, deleteOfferId  }) => {
    ...
    const handleDeleteCategory = async () => {
        setLoading(true);
        await dispatch(DeleteOffer(deleteOfferId))
